...
//            Node<String, String> s = new Node<>(parentName);
//            Edge<String, String> e = new Edge<>(edgeLabel, s, s);
//            g.addEdge(e);
//        } else if(!parentName.equals(childName)){
            Node<String, String> p = new Node<>(parentName);
            Node<String, String> c = new Node<>(childName);
            Edge<String, String> e = new Edge<>(edgeLabel, p, c);
            g.addEdge(e);
        //}
...
//        for(Node<String, String> n : g.getNode(parentName).getChildren()){
            System.out.println(g.getNode(parentName));
            System.out.println(g.getNode(parentName).getChildren());
